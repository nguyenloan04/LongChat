    ...
    return (
        <div className="h-full flex flex-col">
            ...
            <div className="px-2 py-2 h-fit border-b min-h-16">
                <div
                    className={`flex items-center gap-1 border rounded-md bg-neutral-50 ${isInputFocused && "border border-neutral-500"}`}
            ...
            <div className="px-2 flex-1 overflow-y-auto">
                {mockGroupData.map(ele => (
                    <div className="flex items-center gap-3 px-2 py-2 rounded-md my-2 hover:bg-neutral-100 ">
                        <img
                            src={ele.avatar} alt=""
                            className="w-10 h-10 border rounded-full bg-neutral-300"
                        />
