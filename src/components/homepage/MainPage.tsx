...
export default function MainPage() {
    ...
    const grassY = useTransform(scrollYProgress, [0, 1], ["0%", "-40%"]);
    ...
    return (
        <section ref={containerRef}
            ...
            <div className="container top-50 mx-auto px-6 relative z-10 flex flex-col md:flex-row items-center gap-10">
                <motion.div
                    style={{ y: chattingY }}
            ...
            <motion.div
                style={{ y: grassY }}
                className="absolute top-100 left-[30px] md:left-[30%] w-20 md:w-20 z-10 pointer-events-none"
            >
                <motion.img
                    src={grass_img}
            ...
            <motion.div
                style={{ y: grassY }}
                className="absolute top-100 right-[30px] md:right-[30%] w-20 md:w-20 z-10 pointer-events-none"
            >
                <motion.img
                    src={grass_img}
                    animate={{ rotate: [2, -2, 2] }}
